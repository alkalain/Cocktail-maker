...
<template>
  <main class="flex flex-wrap justify-center space-x-0 pt-8 md:h-screen">
    ...
    >
      ...
      <ul
        class="absolute top-[188px] max-h-80 w-[313px] overflow-y-scroll rounded-b-[10px] border-x-2 border-black bg-zinc-300 text-lg md:top-[180px] scrollbar-hidden"
        v-show="rscActivated"
      >
        <li
    ...
    <div
      class="flex h-full w-[90%] justify-center align-top text-lg md:h-[70%] md:w-[70%]"
      v-show="selectedCocktail"
    >
